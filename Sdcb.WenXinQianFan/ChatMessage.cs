...
)
{
    ...
    public static ChatMessage FromUser(string content) => new ChatMessage("user", content);
    ...
    public static ChatMessage FromAssistant(string content) => new ChatMessage("assistant", content);
}
